 ...
 * constructed from the OpCode {@link io.neow3jLegacy.constants.OpCode#PUSHBYTES64} and the transaction
 * signature.
 */
public class RawInvocationScript extends NeoSerializable {
     ...
     * io.neow3jLegacy.constants.OpCode#PUSHBYTES64}. The opcode is not added automatically. Better even,
