...
import io.neow3jLegacy.contract.ScriptBuilder;
import io.neow3jLegacy.contract.ScriptHash;
import io.neow3jLegacy.crypto.Base58;
import io.neow3jLegacy.crypto.Hash;
import io.neow3jLegacy.crypto.exceptions.AddressFormatException;
...
import static io.neow3jLegacy.constants.NeoConstants.MAX_PUBLIC_KEYS_PER_MULTISIG_ACCOUNT;
import static io.neow3jLegacy.utils.ArrayUtils.concatenate;
...
public class Keys {
     ...
     * @deprecated Use {@link io.neow3jLegacy.contract.ScriptHash#fromPublicKey(byte[])} instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link io.neow3jLegacy.contract.ScriptHash#fromAddress(String)} instead.
     */
    @Deprecated
